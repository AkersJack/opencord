...
class Communication:
    ...
    def begin(self):
        start_object = {}
        start_object[
            "service"] = 0  # 0 is to init the service for this connection and sends back the server verification hash
...
class Data:
    ...
    def get_chat(self, start_date, end_date):
        pass
...
if __name__ == "__main__":
    ...
    with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as sock:
        ...
        while data != "/exit":
            ...
            regex = r"""("[^"]*"|'[^']*'|[\S]+)+"""  # Separates the command by word and by quoted items
